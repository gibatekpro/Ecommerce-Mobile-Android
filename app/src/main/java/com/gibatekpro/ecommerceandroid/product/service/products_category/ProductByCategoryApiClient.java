...
public class ProductByCategoryApiClient {
    // Define APIInterface
    static APIInterface apiInterface;

    // create retrofit instance
    public static APIInterface getAPIInterface(Activity context, int categoryId) {
...
//
    ...
    public interface APIInterface {
        ...
        @GET("products/search/findByProductCategoryId")
        Single<ProductResponse> getProductsByPage(@Query("id") int id, @Query("page") int page);
    }
}
